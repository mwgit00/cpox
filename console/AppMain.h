...
public:
    ...
    // actions should NOT generate events for the App
    // but they can generate actions for the Speech Manager / UDP server

    void ActionSRPhrase(const FSMEvent& r);
    void ActionSRRec(const FSMEvent& r);
    void ActionSRStrikes(const FSMEvent& r);
    void ActionSRCancel(const FSMEvent& r);
    ...
    void ActionUDPTxCmd(const FSMEvent& r);
    void ActionUDPRxRecVal(const FSMEvent& r);
